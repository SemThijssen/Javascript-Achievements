...
function finishQuiz() {
  ...
  resultBox.innerHTML = "<h1> Site bezoeker kan een prijs winnen. <h2>Jouw resultaat <br>goede antwoorden " + playerData.goodAnswers + "<br>foute antwoorden " + playerData.wrongAnswers + "</h2>";
}
