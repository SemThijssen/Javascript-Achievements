...
function activateVoice(alpha, beta, gamma){
    ...
    if(alpha > 120){
        let myTxt = "Alsjeblieft stop ik word misselijk.";  
...
function showMyImage(alpha, beta, gamma){
    ...
    if(beta > 40){
        document.getElementById('myImage').src = "image1.jpeg"; // show image
        }
        else {
            document.getElementById('myImage').src = "logo.jpg"; // no image
        }
}